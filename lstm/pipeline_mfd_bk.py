...
if mode == 'train':
    ...
    for target_label in labels:
        ...
        linears = [Linear(i, o) for i, o in
                   zip([hidden_size + el_linear_sizes[-1] + mfd_linear_sizes[-1]] + linear_sizes, linear_sizes + [2])]
        el_linears = [Linear(i, o) for i, o in zip([el_embedding_dim] + el_linear_sizes[:-1], el_linear_sizes)]
    ...
    for target_label in labels:
        ...
        linears = [Linear(i, o) for i, o in zip([saved_state['hidden_size']] + saved_state['linear_sizes'],
    ...
    for target_label in labels:
        ...
        for epoch in range(max_epoch):
            ...
            for batch_idx in range(batch_num):
                ...
                batch_el = el_set.get_batch(batch_tids, volatile=False, gpu=use_gpu)
                batch_mfd = train_mfd_set.get_batch(batch_tids, volatile=False, gpu=use_gpu)
